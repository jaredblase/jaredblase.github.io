  ...
  return (
    <>
      ...
      <div className="relative m-auto grid max-w-screen-xl grid-cols-2">
        ...
        <div className="space-y-24 pb-24 max-w-prose">
          ...
          <section id="experience" className="scroll-m-8">
            ...
            <a className="mt-4 block" target="_blank" href="https://drive.google.com/file/d/1V6Xg2QV1_Lt7BkbbZgDllop_tVxZ3iX7/view?usp=drive_link">View resume</a>
            <a className="block" target="_blank" href="https://drive.google.com/file/d/1FH9lIlOeud1347560ofesHgOskU4NJqg/view?usp=drive_link">View CV</a>
          </section>
          <section id="projects" className="scroll-m-8">
            <div>
              {projects.filter(isPriorityProject).map((p) => <Project key={p.title} project={p} />)}
            </div>
            <a className="mt-4 hover:underline" href="projects">View project archive</a>
          </section>
          <section id="others">
            <ol className="space-y-4">
