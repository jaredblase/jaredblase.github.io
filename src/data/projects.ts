...
export function isPriorityProject(project: Project): project is PriorityProject {
...
export const projects: Project[] = [
  {
    ...
    year: 2025,
    tags: ['React Router', 'TypeScript', 'Tailwind CSS', 'GPT Trainer', 'Frappe'],
    priority: true,
    description: 'Makes the process of petitioning for clearing criminal records much more easier and accessible.',
  },
  {
    title: 'CitiWorld',
    ...
    description: 'A virtual world where you can interact with other people, play games, and have fun.',
  },
  {
    title: 'Abstract',
    ...
    priority: true,
    description: 'This project is an interpreter for various abstract models of computation. These models involve different types of memory storage, memory access, and input-output access.',
  },
  {
    ...
    priority: true,
    description: 'The radio station of De La Salle University where music is directly streamed from the campus to the world.',
  },
  {
    title: 'Luntian',
